...
CGI-FormGenerator-0.92.tar.gz:
	...
	- these modules are optionally used:
		...
		- CGI::SequentialFile 1.01 (for saving guest book messages in files; form
definitions may optionally be stored in this type of file as well)
		- CGI::EventCountFile 1.02 (for saving usage data in files)

libnet-1.0703.tar.gz:
	- by Graham Barr <gbarr@pobox.com>
	- this module is optionally used:
		- Net::SMTP 2.15 (for sending e-mails of form or usage data)
